...
@section('title', 'Register - Aimbot TV')

@section('content')
<div class="glass-card">
    <h2>Create Account</h2>
    <p class="subtitle">Join Aimbot TV to start streaming</p>
    ...
    <p style="text-align: center; color: var(--text-secondary); font-size: 0.9rem;">
        Already have an account? <a href="{{ route('login') }}" style="color: var(--primary); text-decoration: none; font-weight: 600;">Sign In</a>
    </p>
</div>
@endsection
